...
- Develop an expert system that detects structural changes.
 - Examine whether we are able to correctly recover an time-varying infectivity parameter in an age-structured SIR with a simple SIR. 
